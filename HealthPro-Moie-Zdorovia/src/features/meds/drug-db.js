...
export const DRUG_DB = {
  ...
  'аспирин':          { max: 100,  unit: 'мг',       warn: 'не натощак, осторожно с антикоагулянтами' },  // ✚ RU
  ...
  'эналаприл':        { max: 40,   unit: 'мг',       warn: 'контроль калия и почек, возможен кашель' },  // ✚ RU
  ...
  'лизиноприл':       { max: 40,   unit: 'мг',       warn: 'возможен кашель, не при беременности' },    // ✚ RU
  ...
  'амлодипин':        { max: 10,   unit: 'мг',       warn: 'возможны отёки ног' },            // ✚ RU
  ...
  'нифедипин':        { max: 120,  unit: 'мг',       warn: 'не жевать, возможна рефлекторная тахикардия' },  // ✚ RU
  ...
  'бисопролол':       { max: 10,   unit: 'мг',       warn: 'не отменять резко, осторожно при астме' },    // ✚ RU
  ...
  'индапамид':        { max: 2.5,  unit: 'мг',       warn: 'утром, контроль электролитов' },          // ✚ RU
  ...
  'нитроглицерин':    { max: 1,    unit: 'мг разово', warn: 'только при приступе, не более 3 таб.' },    // ✚ RU
  ...
  'метформин':        { max: 3000, unit: 'мг',       warn: 'при диабете, с едой, контроль почек' },    // ✚ RU
  'ібупрофен':        { max: 2400, unit: 'мг',       warn: '⚠️ ПІДВИЩУЄ ТИСК! Не при серцевій недостатності' },
  'ибупрофен':        { max: 2400, unit: 'мг',       warn: '⚠️ ПОВЫШАЕТ ДАВЛЕНИЕ! Не при сердечной недостаточности' },    // ✚ RU
