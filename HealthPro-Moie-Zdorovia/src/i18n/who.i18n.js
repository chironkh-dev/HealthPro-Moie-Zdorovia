...
export const WHO_INFO_T = {
  uk: {
    ...
    'aha_high-normal': {
      title: 'Підвищений (Elevated) — AHA 2017 (120–129 / <80)',
      body:  'За AHA 2017: Підвищений тиск — систолічний 120–129 мм рт.ст. при діастолічному нижче 80. Підвищений ризик прогресування до гіпертонії. Медикаменти не призначаються — достатньо зміни способу життя.',
  ...
  ru: {
    ...
    'aha_high-normal': {
      title: 'Повышенный (Elevated) — AHA 2017 (120–129 / <80)',
      body:  'По AHA 2017: Повышенное давление — систолическое 120–129 мм рт.ст. при диастолическом ниже 80. Повышенный риск прогрессирования до гипертонии. Медикаменты не назначаются — достаточно изменения образа жизни.',
