export const T_UK ={
  ...
  'st-fg-body':'Для точного підрахунку кроків навіть коли додаток закритий, HealthPro запустить фоновий сервіс. Ви побачите постійне сповіщення «HealthPro 🦶 кроки: X/Y». Споживання батареї: +1–3% на день.',
