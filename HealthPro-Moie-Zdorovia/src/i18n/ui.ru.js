export const T_RU ={
  ...
  'st-fg-body':'Для точного подсчёта шагов даже когда приложение закрыто, HealthPro запустит фоновый сервис. Вы увидите постоянное уведомление «HealthPro 🦶 шаги: X/Y». Расход батареи: +1–3% в день.',
