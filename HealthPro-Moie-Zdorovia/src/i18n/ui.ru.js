export const T_RU ={
  ...
  't-exp-btn-quarter':'90 дней',
  't-exp-btn-custom':'Свой период',
  't-exp-format-lbl':'Формат',
  't-exp-format-pdf':'PDF',
  't-exp-format-csv':'CSV',
  't-exp-generate-btn':'Сохранить отчёт',
  't-exp-share-btn':'Поделиться',
  't-exp-share-dialog':'Отправить отчёт врачу',
  'e-share-report-done':'✓ Отчёт отправлен!',
  'e-csv-patient-lbl':'=== ДАННЫЕ ПАЦИЕНТА ===',
  'e-csv-bp-lbl':'=== ИЗМЕРЕНИЯ ДАВЛЕНИЯ ===',
  'e-csv-meds-lbl':'=== ЛЕКАРСТВА ===',
  'e-csv-adher-lbl':'=== ПРИЁМ ЛЕКАРСТВ ===',
  'e-csv-col-name':'ФИО',
  'e-csv-col-age':'Возраст',
  'e-csv-col-gender':'Пол',
  'e-csv-male':'Мужской',
  'e-csv-female':'Женский',
  'e-csv-col-height-weight':'Рост / Вес',
  'e-csv-col-bmi':'ИМТ',
  'e-csv-col-norm':'Личная норма давления',
  'e-csv-col-std':'Стандарт',
  'e-csv-col-period':'Период',
  'e-csv-mmhg':'мм рт.ст.',
  'e-csv-cm':'см',
  'e-csv-kg':'кг',
  'e-csv-col-drug':'Препарат',
  'e-csv-col-dose':'Дозировка',
  'e-csv-col-time-med':'Время приёма',
  'e-csv-col-sched':'Расписание',
  'e-csv-col-adher-pct':'Выполнение %',
  'e-csv-unknown':'Неизвестно',
  'e-toast-csv-error':'Ошибка генерации CSV',
  ...
  't-bp-std-home-text':'Порог гипертензии при домашнем измерении: ≥135/85 мм рт. ст. (вместо ≥140/90 в клинике). Если дома давление ≥135/85 — это уже гипертензия, даже если в клинике было бы «норма».',
