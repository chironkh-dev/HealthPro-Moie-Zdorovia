...
**HealthPro** — персональний щоденник здоров'я для моніторингу артеріального тиску, пульсу, прийому ліків, кроків та аналітики стану організму. Повністю офлайн, без сервера, без хмари. Відбувається збірка та тестування на Android. Плани розвитку: нативна збірка для Android/iOS через Capacitor.
